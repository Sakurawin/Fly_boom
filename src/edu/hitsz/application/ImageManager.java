...
public class ImageManager {
    ...
    static {
        try {
            ...
            ELITE_ENEMY_IMAGE = ImageIO.read(new FileInputStream("src/images/elite.png")); // 精英敌机
            SUPER_ELITE_ENEMY_IMAGE = ImageIO.read(new FileInputStream("src/images/elitePlus.png")); // 超级精英敌机
            BOSS_ENEMY_IMAGE = ImageIO.read(new FileInputStream("src/images/boss.png")); // Boss敌机
            ...
            CLASSNAME_IMAGE_MAP.put(EliteEnemy.class.getName(), ELITE_ENEMY_IMAGE); // 添加精英敌机
            CLASSNAME_IMAGE_MAP.put(SuperEliteEnemy.class.getName(), SUPER_ELITE_ENEMY_IMAGE); // 添加超级精英敌机
            CLASSNAME_IMAGE_MAP.put(BossEnemy.class.getName(), BOSS_ENEMY_IMAGE); // 添加Boss敌机
